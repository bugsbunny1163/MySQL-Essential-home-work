...
-- DROP TABLE Phones, SalaryAndPosition, info;
...
(2, 'normarried', 19920818, 'Kharkiv'),
(3, 'married', 19921126, 'Odessa'),
(4, 'normarried', 19930306, 'Dnipro'),
(5, 'normarried', 19930614, 'Lviv'),
(6, 'married', 19930922, 'Poltava'),
(7, 'married', 19931231, 'Lviv'),
(8, 'normarried', 19940410, 'Lviv'),
(9, 'married', 19940719, 'Kyiv'),
(10, 'normarried', 19941027, 'Kharkiv'),
(11, 'married', 19950204, 'Odessa'),
(12, 'normarried', 19950515, 'Dnipro'),
(13, 'married', 19950823, 'Lviv'),
(14, 'married', 19951201, 'Poltava'),
(15, 'normarried', 19960310, 'Lviv'),
(16, 'normarried', 19960618, 'Lviv'),
(17, 'married', 19960926, 'Kyiv'),
(18, 'married', 19970104, 'Kharkiv'),
(19, 'normarried', 19970414, 'Odessa');